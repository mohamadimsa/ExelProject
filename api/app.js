...
(async () => {
  ...
  const actuatorOptions = {
    basePath: "/exelProject", // It will set /management/info instead of /info
  ...
  app.use(function (req, res, next) {
    res.setHeader("X-Powered-By", "exelProject");
 ...
 // app.use(session(sess));
  ...
  app.get("/", (req, res) => res.send("Welcome to exelProject API !!"));
  ...
  require("./routes/")(app);
  server.listen(8080, () => {
    console.log("[SERVER] start server on port 8080");
  });
})();
